...
*very old code not meant for this repo, many functions this was built with
no longer work the way they did, use this page for reference only*
"""
from numpy import linspace, where
from pandas import DataFrame
from data_generation import get_frags, get_isotope_data
from data_generator import DataGenerator
from calculate_spectra_stats import calc_new_spectrum_stats, calc_spectrum_stats
...
def main():
    ...
    frags = get_frags(fragment_loc)['FragmentMass']
    df = calc_spectrum_stats(df, frags, npzs)
